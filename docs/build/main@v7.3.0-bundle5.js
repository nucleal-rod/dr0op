...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/painter.paper
/*****************************************************************/
...
__etcpack__scope_args__=window.__etcpack__getBundle('52');
    ...
    script.render=function(createElement){
        ...
        return createElement('div',{"quickpaper":"","data-quickpaper-a9fafe76":""},[createElement('nav',{"class":"api-nav","data-quickpaper-a9fafe76":""},[createElement('h2',{"@click":"doScroll(\"new\")","data-quickpaper-a9fafe76":""},["获取画笔"]),createElement('h4',{"@click":"doScroll(\"config\")","data-quickpaper-a9fafe76":""},["配置画笔"]),createElement('h2',{"@click":"doScroll(\"canvas2d\")","data-quickpaper-a9fafe76":""},["位图画笔"]),createElement('h2',{"@click":"doScroll(\"svg\")","data-quickpaper-a9fafe76":""},["矢图画笔"]),createElement('h2',{"@click":"doScroll(\"method\")","data-quickpaper-a9fafe76":""},["画笔上的绘图方法"]),createElement('h4',{"@click":"doScroll(\"method-normal\")","data-quickpaper-a9fafe76":""},["常规方法"]),createElement('h6',{"@click":"doScroll(\"painter-text\")","data-quickpaper-a9fafe76":""},["文字"]),createElement('h6',{"@click":"doScroll(\"painter-arc\")","data-quickpaper-a9fafe76":""},["弧形"]),createElement('h6',{"@click":"doScroll(\"painter-circle\")","data-quickpaper-a9fafe76":""},["圆"]),createElement('h6',{"@click":"doScroll(\"painter-rect\")","data-quickpaper-a9fafe76":""},["矩形"]),createElement('h4',{"@click":"doScroll(\"painter-path\")","data-quickpaper-a9fafe76":""},["路径"]),createElement('h2',{"@click":"doScroll(\"gradient\")","data-quickpaper-a9fafe76":""},["渐变色"]),createElement('h4',{"@click":"doScroll(\"linearGradient\")","data-quickpaper-a9fafe76":""},["线性渐变"]),createElement('h4',{"@click":"doScroll(\"radialGradient\")","data-quickpaper-a9fafe76":""},["环形渐变"]),createElement('h4',{"@click":"doScroll(\"gradient-set\")","data-quickpaper-a9fafe76":""},["设置与使用"]),createElement('h2',{"@click":"doScroll(\"translate\")","data-quickpaper-a9fafe76":""},["变换"]),createElement('h4',{"@click":"doScroll(\"translate-save\")","data-quickpaper-a9fafe76":""},["保存"]),createElement('h4',{"@click":"doScroll(\"translate-restore\")","data-quickpaper-a9fafe76":""},["恢复"]),createElement('h4',{"@click":"doScroll(\"translate-translate\")","data-quickpaper-a9fafe76":""},["移动"]),createElement('h4',{"@click":"doScroll(\"translate-rotate\")","data-quickpaper-a9fafe76":""},["旋转"]),createElement('h4',{"@click":"doScroll(\"translate-scale\")","data-quickpaper-a9fafe76":""},["缩放"])]),createElement('div',{"class":"api-view api-content-view","data-quickpaper-a9fafe76":""},[createElement('p',{"id":"fixed-new","data-quickpaper-a9fafe76":""},["画笔是image2D的主体部分，根据当前绑定的结点不同，获取的是不同类型的画笔，目前支持svg和canvas2D画笔："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["var painter=imageObject.painter();"]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["canvas2D画布如果大小为0或者被隐藏（比如设置display:none）会获取失败并抛错。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["如果维护的第一个结点是canvas，返回的就是专门在canvas上绘图的位图画笔，svg等别的类似。"]),createElement('p',{"id":"fixed-config","data-quickpaper-a9fafe76":""},["获取画笔后就可以调用painter上的方法进行绘图了，不过在这之前，你还可以对画笔进行属性（文字大小，颜色等）配置："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.config();"]),createElement('p',{"data-quickpaper-a9fafe76":""},["考虑到属性设置可能有多个或单个，为了方便，提供两种参数类型："]),createElement('ul',{"data-quickpaper-a9fafe76":""},[createElement('li',{"data-quickpaper-a9fafe76":""},["(json):一次配置多个属性，键值对的方式。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["(key, value):对属性key设置为value。"])]),createElement('p',{"data-quickpaper-a9fafe76":""},["不同画笔的使用大体和上面的类似，差异的部分会在具体的绘图工具下说明，下面我们来看看画笔可配置属性有哪些："]),createElement('ul',{"data-quickpaper-a9fafe76":""},[createElement('li',{"data-quickpaper-a9fafe76":""},["\"fillStyle\":填充色或图案，默认\"#000\"。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"strokeStyle\":轮廓色或图案，默认\"#000\"。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"lineWidth\":线条宽度，默认1(单位px，下同)。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"textAlign\":文字水平对齐方式，默认\"left\"左对齐（还有\"center\"居中和\"right\"右对齐）。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"textBaseline\":文字垂直对齐方式，默认\"middle\"垂直居中（还有\"top\"上对齐和\"bottom\"下对齐）。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"font-size\":文字大小，默认16。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"font-family\":字体，默认\"sans-serif\"。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"arc-start-cap\":圆弧开始端闭合方式，默认\"butt\"直线闭合（还有\"round\"圆帽闭合,\"-round\"反圆帽闭合）。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"arc-end-cap\":圆弧结束端闭合方式，和上一个类似。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["\"lineDash\":设置线条虚线，默认为[]表示使用实线绘制。"])]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["上面的配置项lineDash值应该是一个数组，格式：[实线长，虚线长，实线长 ...]，数组长度任意，会自动循环！"]),createElement('h2',{"id":"fixed-canvas2d","data-quickpaper-a9fafe76":""},["位图画笔"]),createElement('p',{"data-quickpaper-a9fafe76":""},["因为画布隐藏或者大小为零是比较特殊的情况，我们默认会给出警告，你可以在获取画笔的时候传递一个boolean值noHiddenWarn来控制是否需要提示，默认false，也就是给出警告："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["var painter=imageObject.painter(noHiddenWarn);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["除了上面列出的可配置项，因为canvas2D的配置是直接连原始画笔的（不是全部），因此其自身的2d画笔原来可配置的属性依旧可以配置，请知悉。这种绘图方法相对比较简单，下面我们来看看其特有的一些简单的绘图方法"]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["原始画笔的意思是2d上下文，不是我们抽象的painter，因此不同的painter如果管理的是同一个canvas，属性配置不是完全独立的（后面要说明的svg就是独立的）。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["把当前绘制的图形变成base64返回："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["var base64=painter.toDataURL();"]),createElement('p',{"data-quickpaper-a9fafe76":""},["擦除画布上正方形大小是width*height的区域(正方形左上角坐标(x, y))，x和y默认0，width和height默认就是画布的尺寸，都是可选的："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.clearRect(x, y, width, height);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["把图像、画布或视频绘制到画布的指定位置上："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.drawImage();"]),createElement('ul',{"data-quickpaper-a9fafe76":""},[createElement('li',{"data-quickpaper-a9fafe76":""},["(img, x, y):在画布上定位图像。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["(img, x, y, width, height):在画布上定位图像，并规定图像的宽度和高度。"]),createElement('li',{"data-quickpaper-a9fafe76":""},["(img, sx, sy, swidth, sheight, x, y, width, height):剪切图像，并在画布上定位被剪切的部分。"])]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["drawImage接口在v1.5.0版本由于一个设计上的错误，做了参数调整，此版本前升级后请进行相应修改。"]),createElement('h2',{"id":"fixed-svg","data-quickpaper-a9fafe76":""},["矢图画笔"]),createElement('p',{"data-quickpaper-a9fafe76":""},["这种画笔比较特殊，画笔是绑定在维护了svg结点的结点对象上的，不过具体的绘制（比如文字是text标签）却需要对应更具体的标签，因此获取painter方法的时候可以传递一个选择器selector来绑定本次绘制目标（可选）："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["var painter=imageObject.painter(selector);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["因为绘制文字、圆形和圆弧等对应的目标标签不一样，并且一个结点只可以绘制一个图形，因此在每次绘制前都需要明确目标结点："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.bind(selector);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["大部分情况下，selector应该都是模板字符串，绘制结束需要追加到svg中去，我们提供了四种追加方法："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.appendTo|prependTo|afterTo|beforeTo(selector);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["因为限制了查找上下文是获取画笔的svg，只需要传递一个参数，具体方法和前面常规的结点操作一样。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["鉴于svg绘图的特殊性，下面以绘制文字举一个例子来看看绘制整体代码："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["// 获取画笔↵var painter=$$(\"svg\").painter(\"<text>\");↵↵// 配置画笔↵painter.config({↵    \"fillStyle\":\"red\",↵    \"font-size\":30↵});↵↵// 绘制文字并追加到画布↵painter.fillText(\"Step By Step\", 100, 100).appendTo(\"g.text\");"]),createElement('h2',{"id":"fixed-method","data-quickpaper-a9fafe76":""},["画笔上的绘图方法"]),createElement('p',{"id":"fixed-method-normal","data-quickpaper-a9fafe76":""},["上面说明的绘图方法都是具体画笔特有的（因为不同的画笔存在差异），除此之外，大部分方法是通用的。"]),createElement('p',{"id":"fixed-painter-text","data-quickpaper-a9fafe76":""},["在点(x, y)处绘制填充的文字text；deg表示文字旋转角度，可选："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fillText(text, x, y[, deg]);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["在点(x, y)处绘制轮廓的文字text；deg表示文字旋转角度，可选："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.strokeText(text, x, y[, deg]);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["在点(x, y)处绘制轮廓并填充的文字text；deg表示文字旋转角度，可选："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fullText(text, x, y[, deg]);"]),createElement('p',{"id":"fixed-painter-arc","data-quickpaper-a9fafe76":""},["以(cx, cy)为圆心，内外半径分别是r1和r2，从弧度beginDeg开始，跨越弧度deg，绘制填充圆弧："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fillArc(cx, cy, r1, r2, beginDeg, deg);"]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["除非特别说明，角度全部采用弧度值，这是为了方便记忆，别的地方一样。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["和fillArc方法类似，只不过绘制的是轮廓圆弧："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.strokeArc(cx, cy, r1, r2, beginDeg, deg);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["和fillArc方法类似，只不过绘制的是轮廓并填充圆弧："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fullArc(cx, cy, r1, r2, beginDeg, deg);"]),createElement('p',{"id":"fixed-painter-circle","data-quickpaper-a9fafe76":""},["以(cx, cy)为圆心，半径r绘制填充圆形："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fillCircle(cx, cy, r);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["以(cx, cy)为圆心，半径r绘制轮廓圆形："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.strokeCircle(cx, cy, r);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["以(cx, cy)为圆心，半径r绘制轮廓并填充圆形："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fullCircle(cx, cy, r);"]),createElement('p',{"id":"fixed-painter-rect","data-quickpaper-a9fafe76":""},["以(x, y)为左上角，宽width，高height绘制填充矩形："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fillRect(x, y, width, height);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["以(x, y)为左上角，宽width，高height绘制轮廓矩形："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.strokeRect(x, y, width, height);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["以(x, y)为左上角，宽width，高height绘制轮廓并填充矩形："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fullRect(x, y, width, height);"]),createElement('h4',{"id":"fixed-painter-path","data-quickpaper-a9fafe76":""},["路径"]),createElement('p',{"data-quickpaper-a9fafe76":""},["基于路径可以绘制几乎大部分图形，这里独立一小段来说明。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["开始一段独立的路径："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.beginPath();"]),createElement('p',{"data-quickpaper-a9fafe76":""},["闭合当前路径，也就是路径首尾闭合："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.closePath();"]),createElement('p',{"data-quickpaper-a9fafe76":""},["画笔移动到点(x, y)，此时笔离开了画布："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.moveTo(x, y);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["画笔移动到点(x, y)，此时笔没有离开画布："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.lineTo(x, y);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["以(cx, cy)为圆心，半径r，从弧度beginDeg开始，跨越弧度deg画弧，此时笔没有离开画布："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.arc(cx, cy, r, beginDeg, deg);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["二次贝塞尔曲线到"]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.quadraticCurveTo(cpx, cpy, x, y);"]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["只有一个控制点p(cpx, cpy),画笔当前的位置和p(x, y)分别是起点和终点。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["三次贝塞尔曲线到："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y);"]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["有两个控制点p(cp1x, cp1y)和p(cp2x, cp2y),画笔当前的位置和p(x, y)分别是起点和终点。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["把当前路径包裹的区域填充颜色："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.fill();"]),createElement('p',{"data-quickpaper-a9fafe76":""},["把当前路径上色（轮廓线）："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.stroke();"]),createElement('p',{"data-quickpaper-a9fafe76":""},["把当前路径画上轮廓线并填充颜色到当前路径所包裹的区域："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.full();"]),createElement('h2',{"id":"fixed-gradient","data-quickpaper-a9fafe76":""},["渐变色"]),createElement('p',{"data-quickpaper-a9fafe76":""},["除了使用纯色填充，还可以使用渐变色作为画笔的颜色，你把它看成普通的颜色使用就可以了。"]),createElement('h4',{"id":"fixed-linearGradient","data-quickpaper-a9fafe76":""},["线性渐变"]),createElement('p',{"data-quickpaper-a9fafe76":""},["首先你需要使用画笔的createLinearGradient创建线性渐变对象，四个参数分别表示渐变的起点P(x1, y1)和终点P(x2, y2)："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["var linearGradient = painter.createLinearGradient(x1, y1, x2, y2);"]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["温馨提示：canvas画笔上述参数的单位是px，svg画笔上述参数是%，请一定要注意区分（下同）。"]),createElement('h4',{"id":"fixed-radialGradient","data-quickpaper-a9fafe76":""},["环形渐变"]),createElement('p',{"data-quickpaper-a9fafe76":""},["同样的，你需要使用画笔的createRadialGradient创建环形渐变对象，三个参数分别表示渐变的圆心P(cx, cy)和半径r："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["var radialGradient = painter.createRadialGradient(cx, cy, r);"]),createElement('p',{"class":"warn","data-quickpaper-a9fafe76":""},["温馨提示：渐变的起点是圆心。"]),createElement('h4',{"id":"fixed-gradient-set","data-quickpaper-a9fafe76":""},["设置与使用"]),createElement('p',{"data-quickpaper-a9fafe76":""},["设置渐变范围以后，你需要在渐变范围中添加渐变色，可以添加任意多个："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["XXXGradient.addColorStop(deep, color);"]),createElement('p',{"data-quickpaper-a9fafe76":""},["上述deep取值为闭区间[0, 1]，color可以是任意合法的颜色值。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["渐变如何使用，直接调用渐变的value方法即可："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.config({↵    \"fillStyle\": XXXGradient.value()↵});"]),createElement('p',{"data-quickpaper-a9fafe76":""},["比如上面，我们给画笔设置填充色就是使用了我们刚刚获取的渐变色。"]),createElement('h2',{"id":"fixed-translate","data-quickpaper-a9fafe76":""},["变换"]),createElement('p',{"data-quickpaper-a9fafe76":""},["这里的变换指的是画笔相对画布的变换，和坐标变换不一样，前者改变的是画笔特性，或者是求解点坐标的方法。"]),createElement('p',{"data-quickpaper-a9fafe76":""},["在说明具体的变换方法前，我们先来看两个与之相关的基本方法。"]),createElement('h4',{"id":"fixed-translate-save","data-quickpaper-a9fafe76":""},["保存"]),createElement('p',{"data-quickpaper-a9fafe76":""},["保存当前的绘图状态："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.save();"]),createElement('h4',{"id":"fixed-translate-restore","data-quickpaper-a9fafe76":""},["恢复"]),createElement('p',{"data-quickpaper-a9fafe76":""},["恢复之前保存的绘图状态："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.restore();"]),createElement('p',{"data-quickpaper-a9fafe76":""},["接着，我们说明几个具体的变换方法。"]),createElement('h4',{"id":"fixed-translate-translate","data-quickpaper-a9fafe76":""},["移动"]),createElement('p',{"data-quickpaper-a9fafe76":""},["把绘图的原点x坐标增加dx，y增加dy："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.translate(dx, dy);"]),createElement('h4',{"id":"fixed-translate-rotate","data-quickpaper-a9fafe76":""},["旋转"]),createElement('p',{"data-quickpaper-a9fafe76":""},["围绕原点旋转deg："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.rotate(deg);"]),createElement('h4',{"id":"fixed-translate-scale","data-quickpaper-a9fafe76":""},["缩放"]),createElement('p',{"data-quickpaper-a9fafe76":""},["x坐标和y坐标分别缩放sx和sy倍（sy缺省取sx）："]),createElement('pre',{"q-code":"","data-quickpaper-a9fafe76":""},["painter.scale(sx[, sy]);"])])])
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/painter.paper?QuickPaper&type=script&lang=js&hash=a9fafe76
/*****************************************************************/
window.__etcpack__bundleSrc__['51']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
    __etcpack__scope_args__=window.__etcpack__getBundle('38');
var changeActive =__etcpack__scope_args__.default;
...
/*************************** [bundle] ****************************/
// Original file:./src/Service/changeActive.js
/*****************************************************************/
...
__etcpack__scope_bundle__.default= function (className, tagetClass) {
...
var getUrlParam =__etcpack__scope_args__.default;

__etcpack__scope_bundle__.default= function (element, overValue) {
  overValue = overValue || 0;
  element = element || document.documentElement;
  var fixed = getUrlParam().fixed;

  if (fixed) {
    // 获取滚动调整结点
    var fixedDom = $$('#fixed-' + fixed);

    if (fixedDom.length > 0) {
      var offsetTop = fixedDom[0].offsetTop - overValue;
...
/*************************** [bundle] ****************************/
// Original file:./src/Service/getUrlParam.js
/*****************************************************************/
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/painter.paper?QuickPaper&type=style&lang=css&hash=a9fafe76
/*****************************************************************/
