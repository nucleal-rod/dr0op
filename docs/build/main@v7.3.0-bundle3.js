...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/how-to-use.paper
/*****************************************************************/
...
__etcpack__scope_args__=window.__etcpack__getBundle('48');
    ...
    script.render=function(createElement){
        ...
        return createElement('div',{"quickpaper":"","data-quickpaper-1837add8":""},[createElement('nav',{"class":"api-nav","data-quickpaper-1837add8":""},[createElement('h2',{"@click":"doScroll(\"purpose\")","data-quickpaper-1837add8":""},["关注的问题"]),createElement('h2',{"@click":"doScroll(\"import\")","data-quickpaper-1837add8":""},["如何引入?"]),createElement('h2',{"@click":"doScroll(\"example\")","data-quickpaper-1837add8":""},["一个简单的用例"]),createElement('h4',{"@click":"doScroll(\"example-step1\")","data-quickpaper-1837add8":""},["获取画笔"]),createElement('h4',{"@click":"doScroll(\"example-step2\")","data-quickpaper-1837add8":""},["配置"]),createElement('h4',{"@click":"doScroll(\"example-step3\")","data-quickpaper-1837add8":""},["绘图方法"]),createElement('h2',{"@click":"doScroll(\"help\")","data-quickpaper-1837add8":""},["获取帮助"])]),createElement('div',{"class":"api-view api-content-view","data-quickpaper-1837add8":""},[createElement('p',{"data-quickpaper-1837add8":""},["首先，让我们来了解一个这个库主要解决的问题是什么，如何使用以及问题反馈等基本信息。"]),createElement('h2',{"id":"fixed-purpose","data-quickpaper-1837add8":""},["关注的问题"]),createElement('p',{"data-quickpaper-1837add8":""},["本库致力于提供更简单的Web端二维绘图接口，主要包括这些方面：画笔、辅助计算、结点操作和一些零碎的小工具方法。我们希望绘图是简单而有趣的、高效而愉悦的！"]),createElement('p',{"data-quickpaper-1837add8":""},["主要是在svg和canvas2D上绘图，虽然有提供比如Maritx4坐标变换等三维相关方法，这是考虑到一些潜在的需求。"]),createElement('h2',{"id":"fixed-import","data-quickpaper-1837add8":""},["如何引入?"]),createElement('p',{"data-quickpaper-1837add8":""},["如果你开发的是一个web项目，直接在页面引入打包后的文件后即可（在代码中通过image2D或$$调用）："]),createElement('pre',{"q-code":"","data-quickpaper-1837add8":""},["<script src=\"https://cdn.jsdelivr.net/npm/image2d@1\"></script>"]),createElement('p',{"data-quickpaper-1837add8":""},["如果你想通过npm方式管理，首先你需要通过命令行安装image2D，就像这样："]),createElement('pre',{"q-code":"","data-quickpaper-1837add8":""},["npm install --save image2d"]),createElement('p',{"data-quickpaper-1837add8":""},["安装好了以后，在需要的地方引入即可："]),createElement('pre',{"q-code":"","data-quickpaper-1837add8":""},["import $$ from \"image2d\";"]),createElement('h2',{"id":"fixed-example","data-quickpaper-1837add8":""},["一个简单的用例"]),createElement('p',{"data-quickpaper-1837add8":""},["作为入门，我们这里只是简单的说明一下如何绘图，具体的辅助方法和一些细节在文档有进行说明，或者你可以提issue进行交流，为了简化，这里不再赘述。"]),createElement('h6',{"id":"fixed-example-step1","data-quickpaper-1837add8":""},["获取画笔"]),createElement('p',{"data-quickpaper-1837add8":""},["绘图的第一步当然是获取画笔了，画笔分为两种：Canvas2D和SVG，我们来看看具体的代码："]),createElement('pre',{"q-code":"","data-quickpaper-1837add8":""},["var painter=$$(\"#painter\").painter();"]),createElement('p',{"data-quickpaper-1837add8":""},["上面的$$(\"#painter\")返回一个image2D对象，通过ID选择器查找结点，然后调用对象上的painter方法就可以获取画笔了。"]),createElement('p',{"data-quickpaper-1837add8":""},["如何判断画笔的类型？如果结点是canvas获取的就是Canvas2D画笔，如果结点是svg获取的就是SVG画笔。"]),createElement('h6',{"id":"fixed-example-step2","data-quickpaper-1837add8":""},["配置"]),createElement('p',{"data-quickpaper-1837add8":""},["不管是什么画笔，都一样可以进行配置（当然有缺省值），比如画笔的粗细，颜色等，下面列出部分选项："]),createElement('pre',{"q-code":"","data-quickpaper-1837add8":""},["painter.config({↵    \"font-size\":文字大小,↵    \"lineWidth\":线条宽度,↵    ......↵});"]),createElement('p',{"data-quickpaper-1837add8":""},["具体的配置选项请查看画笔一节。"]),createElement('h6',{"id":"fixed-example-step3","data-quickpaper-1837add8":""},["绘图方法"]),createElement('p',{"data-quickpaper-1837add8":""},["画笔获取并配置好了以后，直接调用画笔上的方法即可绘图，我们拿canvas举例子。"]),createElement('pre',{"q-code":"","data-quickpaper-1837add8":""},["$$(\"canvas\")↵.attr({↵    \"with\":200,↵    \"height\":100↵})↵.painter()↵.config({↵    \"lineWidth\":10,↵    \"fillStyle\":\"red\",↵    \"strokeStyle\":\"green\"↵})↵.fillArc(100, 0, 50, 100, 0, Math.PI)↵.strokeArc(100, 0, 50, 95, 0, Math.PI);"]),createElement('p',{"data-quickpaper-1837add8":""},["具体的绘图方法也请查看文档。绘制的结果如下："]),createElement('div',{"class":"guider-demo1","data-quickpaper-1837add8":""},[]),createElement('p',{"data-quickpaper-1837add8":""},["怎么样？是不是很简单，虽然直接使用canvas或svg也可以实现，不过借助这个库绘图会更简单，你可以把更多的精力放在绘制出更有趣的作品上。"]),createElement('h2',{"id":"fixed-help","data-quickpaper-1837add8":""},["获取帮助"]),createElement('p',{"data-quickpaper-1837add8":""},["在使用image2D的时候，如果遇到任何疑惑或问题，包括建议或对未来版本的想法，请先在",createElement('a',{"target":"_blank","href":"https://github.com/hai2007/image2D/issues","data-quickpaper-1837add8":""},["Github issue"]),"上查找是否存在相似内容，然后进行补充或追问，当然也可以增加新的话题进行交流，除非特殊情况，你会在48小时内获得",createElement('a',{"href":"mailto:2501482523@qq.com","data-quickpaper-1837add8":""},["作者"]),"回复。"])])])
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/how-to-use.paper?QuickPaper&type=script&lang=js&hash=1837add8
/*****************************************************************/
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/how-to-use.paper?QuickPaper&type=style&lang=css&hash=1837add8
/*****************************************************************/
...
styleElement.innerHTML = "\n .guider-demo1[data-quickpaper-1837add8]{\n\nbackground-image: url(\"./image/guider-demo1.png\");\n\nheight: 1.6rem;\n\nbackground-repeat: no-repeat;\n\nbackground-position: left center;\n\nbackground-size: auto 100%;\n\n}\n";
