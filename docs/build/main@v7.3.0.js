...
window.__etcpack__bundleSrc__['23']=function(){
  ...
  "guide": {
    "content": function content() {
      return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle1.js','24');
    }
  },
  "api": {
    "content": function content() {
      return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle2.js','25');
    },
    "how-to-use": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle3.js','26');
      }
    },
    "xhtml": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle4.js','27');
      }
    },
    "painter": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle5.js','28');
      }
    },
    "calculate": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle6.js','29');
      }
    },
    "tool": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle7.js','30');
      }
    },
  ...
  "course": {
    "content": function content() {
      return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle8.js','31');
    },
    "author": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle9.js','32');
      }
    },
    "install": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle10.js','33');
      }
    },
    "introduce": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle11.js','34');
      }
    },
    "svg-painter": {
      "content": function content() {
        return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle12.js','35');
      }
    },
    "_default_": "install"
  },
  "QA": {
    "content": function content() {
      return window.__etcpack__getLazyBundle('./build/main@v7.3.0-bundle13.js','36');
    }
  },
  "_default_": "guide"
};
