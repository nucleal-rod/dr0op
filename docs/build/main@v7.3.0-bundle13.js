...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/QA.paper
/*****************************************************************/
window.__etcpack__bundleSrc__['36']=function(){
    ...
    // 导入js
__etcpack__scope_args__=window.__etcpack__getBundle('67');
var script =__etcpack__scope_args__.default;


    // 导入css
__etcpack__scope_args__=window.__etcpack__getBundle('68');


    script.render=function(createElement){

        return createElement('div',{"quickpaper":"","data-quickpaper-17278706":""},[createElement('div',{"class":"api-view","data-quickpaper-17278706":""},[createElement('p',{"data-quickpaper-17278706":""},["这里汇总开发中常见问题，如果这里没有包含你的疑惑，可以去",createElement('a',{"href":"https://github.com/hai2007/image2D/issues","data-quickpaper-17278706":""},["issue"]),"中提，有价值的最终会被整理回这里！"]),createElement('h2',{"id":"fixed-issue11","class":"title","data-quickpaper-17278706":""},["[1] 为什么选择canvas作为画布绘图的时候会出现线条模糊？"]),createElement('p',{"data-quickpaper-17278706":""},["首先，线条很虚的原因是绘制方式导致的，具体原因可能有下列情况（还可能有别的原因）："]),createElement('h4',{"data-quickpaper-17278706":""},["情况一：绘制方法问题导致了线条重叠"]),createElement('p',{"data-quickpaper-17278706":""},["例子代码位于本项目的laboratory文件夹中：",createElement('a',{"href":"https://github.com/hai2007/image2D/blob/master/laboratory/draw-method-0.5Px.html","target":"_blank","data-quickpaper-17278706":""},["draw-method-0.5Px.html"])]),createElement('p',{"data-quickpaper-17278706":""},["你可以通过选择使用【绘制方法一】和【绘制方法二】的代码来查看效果，明细前者是糟糕的，因为重叠绘制了。"]),createElement('h4',{"data-quickpaper-17278706":""},["情况二：canvas本身是位图，存在0.5px问题"]),createElement('p',{"data-quickpaper-17278706":""},["canvas画布本身由于0.5Px问题，存在天然的模糊问题，需要通过一定方法实现，比如看看这里实验用例：",createElement('a',{"href":"https://github.com/hai2007/image2D/blob/master/laboratory/canvas-0.5Px.html","target":"_blank","data-quickpaper-17278706":""},["canvas-0.5Px.html"]),",image2D本身已经进行了一些优化，解决了一部分问题。"])])])
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/QA.paper?QuickPaper&type=script&lang=js&hash=17278706
/*****************************************************************/
window.__etcpack__bundleSrc__['67']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/QA.paper?QuickPaper&type=style&lang=css&hash=17278706
/*****************************************************************/
window.__etcpack__bundleSrc__['68']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
    var styleElement = document.createElement('style');
var head = document.head || document.getElementsByTagName('head')[0];
styleElement.innerHTML = "\n .title[data-quickpaper-17278706]{\n\nborder-bottom: 1px solid gray;\n\nmargin-top: .2rem;\n\n}\n";
