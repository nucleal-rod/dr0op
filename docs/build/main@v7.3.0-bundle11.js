...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/course/introduce.paper
/*****************************************************************/
window.__etcpack__bundleSrc__['34']=function(){
    ...
    // 导入js
__etcpack__scope_args__=window.__etcpack__getBundle('63');
var script =__etcpack__scope_args__.default;


    // 导入css
__etcpack__scope_args__=window.__etcpack__getBundle('64');


    script.render=function(createElement){

        return createElement('div',{"quickpaper":"","data-quickpaper-1e9a77d0":""},[createElement('div',{"class":"course-view","data-quickpaper-1e9a77d0":""},[createElement('header',{"id":"fixed-top","data-quickpaper-1e9a77d0":""},["介绍"]),createElement('h2',{"id":"fixed-what","data-quickpaper-1e9a77d0":""},["image2D是什么？"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["原生浏览器提供了",createElement('span',{"class":"important","data-quickpaper-1e9a77d0":""},["Canvas2D"]),"和",createElement('span',{"class":"important","data-quickpaper-1e9a77d0":""},["SVG"]),"画布，分别用于绘制位图和矢图，不过存在一些问题："]),createElement('ul',{"data-quickpaper-1e9a77d0":""},[createElement('li',{"data-quickpaper-1e9a77d0":""},["不同浏览器存在兼容问题，同样的代码绘制出来的效果存在非常明显的差异。"]),createElement('li',{"data-quickpaper-1e9a77d0":""},["画布本身的缺陷，Canvas2D存在锯齿模糊问题而SVG标签操作比较麻烦。"]),createElement('li',{"data-quickpaper-1e9a77d0":""},["计算问题，比如树图、插值、坐标变换等较麻烦的计算会消耗绘图的乐趣。"])]),createElement('p',{"data-quickpaper-1e9a77d0":""},["为了解决这些问题我们抽象出了",createElement('span',{"class":"important","data-quickpaper-1e9a77d0":""},["image2D"]),"库以兼容不同浏览器，在屏蔽了两种画布差异的同时保留了各自的优点，并且进行一些必要的抽象（比如针对Canvas2D新增了图层），又提供了一些有意义的辅助计算和补充方法。"]),createElement('h1',{"data-quickpaper-1e9a77d0":""},["演示如何绘制一个圆弧"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["下面我们来演示如何使用Canvas2D画笔绘制一个圆弧（SVG画笔和复杂图形请通过后续教程进行学习）！"]),createElement('h2',{"id":"fixed-painter","data-quickpaper-1e9a77d0":""},["获取画笔"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["需要注意的是，image2D的思想是进行一层抽象来屏蔽那些不友好的差异，因此整体设计和原生的类似，同样存在两种画笔，我们来看看Canvas2D画笔如何获取："]),createElement('pre',{"q-code":"","data-quickpaper-1e9a77d0":""},["// 我们假定我们现在在页面有一个canvas标签↵var painter=$$('canvas').attr({↵    \"width\":300,↵    \"height\":300↵}).painter();"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["上面的$$('canvas')返回一个 image2D 对象，通过属性",createElement('a',{"href":"#/api/xhtml?fixed=selector","target":"_blank","data-quickpaper-1e9a77d0":""},["选择器"]),"查找结点，我们设置了画布的大小，然后调用对象上的 painter 方法就可以获取画笔了。"]),createElement('h2',{"id":"fixed-config","data-quickpaper-1e9a77d0":""},["配置画笔"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["比如说画笔的颜色，线条粗细等，虽然全部有默认值，不过大部分情况下你可能需要对某些特性进行配置："]),createElement('pre',{"q-code":"","data-quickpaper-1e9a77d0":""},["painter.config({↵    'strokeStyle':'red',↵    'lineWidth':3,↵    'lineDash':[5]↵});"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["上面我们配置了线条的颜色，粗细和类型。"]),createElement('h2',{"id":"fixed-chart","data-quickpaper-1e9a77d0":""},["绘制简单图形"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["画笔获取并配置好了以后，直接调用",createElement('a',{"href":"#/api/painter?fixed=method","target":"_blank","data-quickpaper-1e9a77d0":""},["画笔上的方法"]),"即可绘图："]),createElement('pre',{"q-code":"","data-quickpaper-1e9a77d0":""},["painter.strokeArc(150, 150, 100, 130, Math.PI/2, Math.PI/2*3);"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["这样，一个圆弧就绘制好了，可以",createElement('a',{"href":"./inline/example-1.html","target":"_blank","data-quickpaper-1e9a77d0":""},["点击此次"]),"查看运行效果。"]),createElement('p',{"data-quickpaper-1e9a77d0":""},["怎么样？是不是很简单，你可以把更多的精力放在设计更多有趣图形上，这个库永远都是自由、开源、讨论和进步的，欢迎提出任何",createElement('a',{"href":"https://github.com/hai2007/image2D/issues","target":"_blank","data-quickpaper-1e9a77d0":""},["意见"]),"来帮忙我们改进。"])])])
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/course/introduce.paper?QuickPaper&type=script&lang=js&hash=1e9a77d0
/*****************************************************************/
window.__etcpack__bundleSrc__['63']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/course/introduce.paper?QuickPaper&type=style&lang=css&hash=1e9a77d0
/*****************************************************************/
window.__etcpack__bundleSrc__['64']=function(){
    var __etcpack__scope_bundle__={};
    var __etcpack__scope_args__;
