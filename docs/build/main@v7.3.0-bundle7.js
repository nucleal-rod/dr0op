...
__etcpack__scope_args__=window.__etcpack__getBundle('56');
    ...
    script.render=function(createElement){
        ...
        return createElement('div',{"quickpaper":"","data-quickpaper-50f101da":""},[createElement('nav',{"class":"api-nav","data-quickpaper-50f101da":""},[createElement('h2',{"@click":"doScroll(\"layer\")","data-quickpaper-50f101da":""},["位图图层"]),createElement('h4',{"@click":"doScroll(\"layer-new\")","data-quickpaper-50f101da":""},["创建图层管理对象"]),createElement('h4',{"@click":"doScroll(\"layer-get\")","data-quickpaper-50f101da":""},["获取或创建图层"]),createElement('h4',{"@click":"doScroll(\"layer-delete\")","data-quickpaper-50f101da":""},["删除图层"]),createElement('h4',{"@click":"doScroll(\"layer-update\")","data-quickpaper-50f101da":""},["更新图层到画布"]),createElement('h4',{"@click":"doScroll(\"layer-hidden\")","data-quickpaper-50f101da":""},["隐藏图层"]),createElement('h4',{"@click":"doScroll(\"layer-show\")","data-quickpaper-50f101da":""},["显示图层"]),createElement('h2',{"@click":"doScroll(\"animation\")","data-quickpaper-50f101da":""},["动画或定时轮询"]),createElement('h2',{"@click":"doScroll(\"colors\")","data-quickpaper-50f101da":""},["颜色计算相关方法"]),createElement('h4',{"@click":"doScroll(\"colors-formatColor\")","data-quickpaper-50f101da":""},["颜色格式化"]),createElement('h4',{"@click":"doScroll(\"colors-getRandomColors\")","data-quickpaper-50f101da":""},["获取一组随机色"]),createElement('h4',{"@click":"doScroll(\"colors-getLoopColors\")","data-quickpaper-50f101da":""},["获取循环色"]),createElement('h2',{"@click":"doScroll(\"ruler\")","data-quickpaper-50f101da":""},["刻度尺辅助计算"])]),createElement('div',{"class":"api-view api-content-view","data-quickpaper-50f101da":""},[createElement('p',{"data-quickpaper-50f101da":""},["因为绘制的时候，比如canvas2D没有图层，某个数据改变可能就意味着需要全部重新绘制等，基于这些考虑，在这一章，对前面进行必要的补充。"]),createElement('h2',{"id":"fixed-layer","data-quickpaper-50f101da":""},["位图图层"]),createElement('p',{"id":"fixed-layer-new","data-quickpaper-50f101da":""},["首先需要明确，图层服务的对象是canvas2D，svg某种意义上天生具有图层，不需要额外设计。让我们首先看看如何获取一个图层对象："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["var layer=imageObject.layer();"]),createElement('p',{"data-quickpaper-50f101da":""},["这里的图层可以类比photoshop的图层去理解，我们提供了几个类似的方法来帮助使用图层对象。"]),createElement('p',{"id":"fixed-layer-get","data-quickpaper-50f101da":""},["图层对象管理着图层，通过传递id可以获取对应图层的画笔，如果该图层不存在会自动创建（这里的画笔就是canvas2D画笔）："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["var painter=layer.painter(id);"]),createElement('p',{"id":"fixed-layer-delete","data-quickpaper-50f101da":""},["删除指定图层："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["layer.delete(id);"]),createElement('p',{"id":"fixed-layer-update","data-quickpaper-50f101da":""},["图层中的内容不会显示在画布上，为了显示在画布上，需要手动更新："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["layer.update();"]),createElement('p',{"id":"fixed-layer-hidden","data-quickpaper-50f101da":""},["隐藏图层："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["layer.hidden(id);"]),createElement('p',{"id":"fixed-layer-show","data-quickpaper-50f101da":""},["显示图层："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["layer.show(id);"]),createElement('p',{"class":"warn","data-quickpaper-50f101da":""},["图层的创建越晚离眼睛距离越近。"]),createElement('h2',{"id":"fixed-animation","data-quickpaper-50f101da":""},["动画或定时轮询"]),createElement('p',{"data-quickpaper-50f101da":""},["绘图的时候，为了实现动画效果，你除了可以使用画布或css天然的动画相关属性，还可以使用ES绘制每一帧的方式实现。为了方便你绘制我们提供了下面方法："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["var stop=$$.animation(function(deep){↵    // deep取值0-1，表示动画进度↵}, speeds, function(deep){↵    // deep和上面一样，提供的原因是有时候结束回调是stop方法触发而不是动画结束了↵},timing);"]),createElement('p',{"data-quickpaper-50f101da":""},["该方法有四个参数：分别表示画帧方法、动画时长、动画结束回调和进度控制参数（动画时长单位毫秒，最后三个均可选）。"]),createElement('p',{"data-quickpaper-50f101da":""},["其中timing可以为字符串或数组，字符串可选参数有：\"ease\"、\"ease-in\"、\"ease-in-out\"、\"ease-out\"和\"linear\"（默认值），值的意义和css中的属性↵            transition-timing-function 基本一致，数组的话也是和这个属性保持一致，长度为4。"]),createElement('p',{"data-quickpaper-50f101da":""},["如果你希望动画立刻结束，可以调用下面的方法强行提前停止："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["stop();"]),createElement('h2',{"id":"fixed-colors","data-quickpaper-50f101da":""},["颜色计算相关方法"]),createElement('p',{"id":"fixed-colors-formatColor","data-quickpaper-50f101da":""},["给定任意一个合法的css颜色字符串，把颜色统一转变成rgba格式，返回一个数组[r,g,b,a]："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["var rgbaArray=$$.formatColor(colorString);"]),createElement('p',{"id":"fixed-colors-getRandomColors","data-quickpaper-50f101da":""},["传递需要的颜色个数，返回一组随机色彩："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["// alpha可选，取值是0-1，表示颜色透明度↵var colors=$$.getRandomColors(number, alpha);"]),createElement('p',{"id":"fixed-colors-getLoopColors","data-quickpaper-50f101da":""},["传递需要的颜色个数，返回一组循环色彩："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["// alpha可选，取值是0-1，表示颜色透明度↵var colors=$$.getLoopColors(number, alpha);"]),createElement('h2',{"id":"fixed-ruler","data-quickpaper-50f101da":""},["刻度尺辅助计算"]),createElement('div',{"ui-copy":"","data-quickpaper-50f101da":""},[createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["// 分别表示最大值，最小值和间隔数↵var rulerData = $$.ruler(maxValue, minValue, number);"]),createElement('p',{"data-quickpaper-50f101da":""},["返回的数据格式如下："]),createElement('pre',{"q-code":"","data-quickpaper-50f101da":""},["rulerData = {↵    min: number, // 最小值↵    max: number , // 最大值↵    distance: number , // 步进↵    num: number // 间隔数↵    ruler: Array<number> // 刻度数数组↵};"]),createElement('p',{"class":"warn","data-quickpaper-50f101da":""},["温馨提示：传递的间隔数对于最终计算只是作为一个参考，实际的间隔数以返回的结果为准。"])])])])
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/tool.paper?QuickPaper&type=script&lang=js&hash=50f101da
/*****************************************************************/
...
/*************************** [bundle] ****************************/
// Original file:./src/Pages/api/tool.paper?QuickPaper&type=style&lang=css&hash=50f101da
/*****************************************************************/
